                ...
                <Grid container direction="row" justify={matchesSM ? "center" : undefined }
                    ...
                    <Grid item style={{ marginLeft: matchesSM ? 0 : "5em", 
                        ...
                        <Typography variant="subtitle1">
                            Custom digital solutions, from investigation to{" "}
            ...
            <Grid item> 
                ...
                <Grid container direction="row" justify={matchesSM ? "center" : "flex-end" }
                    ...
                    <Grid item style={{ marginRight: matchesSM ? 0 : "5em" }}>
                        <img className={classes.icon} 
                            alt="mobile apps icon" src={mobileAppsIcon}/>
                    </Grid>
                </Grid>
            </Grid>
            <Grid item>
                ...
                <Grid container direction="row" justify={matchesSM ? "center" : undefined }
                    ...
                    <Grid item>
                        <img className={classes.icon} 
                            alt="website icon" src={websitesIcon}/>
                    </Grid>
                </Grid>
            </Grid>
                            {/* ------ Revolution BLOCK ------- */}
            <Grid item>
                <Grid container alignItems="center" justify="center" style={{height: "100em", marginTop:"12em"}}>
                    <Card className={classes.revolutionCard}>
                        <CardContent>
                            <Grid direction="column" container style={{textAlign:"center"}}>
                                <Grid item>
                                ...
                                <Grid item>
                                    <Typography variant="subtitle1" gutterBottom>
                                        Visionary insight coupled with cutting-edge technology 
                                        is a recipe for revolution
                                    </Typography>
                                    <Button 
                                        onClick={() => props.setValue(2)}
                                        component={Link} to="/revolution" 
                                        className={classes.learnButtonHero} variant="outlined">
                                        <span style={{ marginRight: 10}}>Learn More</span>
                                        <ButtonArrow width={15} height={15} 
                                            fill={theme.palette.common.blue}/>
                                    </Button>
